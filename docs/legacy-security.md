# Historical Electron security notes

Archived implementation notes, not current native-client guarantees. Commands,
versions, scan results and deployment claims below are historical and may be stale.
For current policy and limitations, see [SECURITY.md](../SECURITY.md).
...
[GitHub Security Advisories](https://github.com/ossmalaysia/macvnc/security/advisories/new)
