...
**[latest release](https://github.com/ossmalaysia/macvnc/releases/latest)**:
...
```bash
git clone https://github.com/ossmalaysia/macvnc.git
cd macvnc
npm install
npm start
```
...
Report vulnerabilities privately via [GitHub Security Advisories](https://github.com/ossmalaysia/macvnc/security/advisories/new).
